...
#include "SIK_RequestSpectatorServerList_AsyncFunction.h"

#include "SIK_SharedFile.h"
#include "Async/Async.h"

USIK_RequestSpectatorServerList_AsyncFunction* USIK_RequestSpectatorServerList_AsyncFunction::RequestSpectatorServerList(FSIK_AppId AppId,
	const TMap<FString, FString>& Filters, float TimeOut)
{
	USIK_RequestSpectatorServerList_AsyncFunction* BlueprintNode = NewObject<USIK_RequestSpectatorServerList_AsyncFunction>();
...
void USIK_RequestSpectatorServerList_AsyncFunction::Activate()
{
	Super::Activate();
	...
	HServerListRequest Request = SteamMatchmakingServers()->RequestSpectatorServerList(VarAppId.GetAppID(), &KeyValuePairs, Filters.Num(), this);
...
#if (WITH_ENGINE_STEAM && ONLINESUBSYSTEMSTEAM_PACKAGE) || (WITH_STEAMKIT && !WITH_ENGINE_STEAM)
void USIK_RequestSpectatorServerList_AsyncFunction::ServerResponded(HServerListRequest hRequest, int iServer)
{
...
void USIK_RequestSpectatorServerList_AsyncFunction::ServerFailedToRespond(HServerListRequest hRequest, int iServer)
{
...
void USIK_RequestSpectatorServerList_AsyncFunction::RefreshComplete(HServerListRequest hRequest,
