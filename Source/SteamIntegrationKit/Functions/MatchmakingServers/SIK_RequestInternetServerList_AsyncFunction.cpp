...
#include "SIK_RequestInternetServerList_AsyncFunction.h"

#include "SIK_SharedFile.h"
#include "Async/Async.h"

USIK_RequestInternetServerList_AsyncFunction* USIK_RequestInternetServerList_AsyncFunction::RequestInternetServerList(FSIK_AppId AppId,
	const TMap<FString, FString>& Filters, float TimeOut)
{
	USIK_RequestInternetServerList_AsyncFunction* BlueprintNode = NewObject<USIK_RequestInternetServerList_AsyncFunction>();
...
void USIK_RequestInternetServerList_AsyncFunction::Activate()
{
	Super::Activate();
	...
	HServerListRequest Request = SteamMatchmakingServers()->RequestInternetServerList(VarAppId.GetAppID(), &KeyValuePairs, Filters.Num(), this);
...
#if (WITH_ENGINE_STEAM && ONLINESUBSYSTEMSTEAM_PACKAGE) || (WITH_STEAMKIT && !WITH_ENGINE_STEAM)
void USIK_RequestInternetServerList_AsyncFunction::ServerResponded(HServerListRequest hRequest, int iServer)
{
...
void USIK_RequestInternetServerList_AsyncFunction::ServerFailedToRespond(HServerListRequest hRequest, int iServer)
{
...
void USIK_RequestInternetServerList_AsyncFunction::RefreshComplete(HServerListRequest hRequest,
